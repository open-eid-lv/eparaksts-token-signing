...
- (NSString *)showForWindow:(NSWindow *)window withName:(const char *)name withMessage:(const char *)message withPinName:(const char *)pinName withMinAcceptablePin2Length:(unsigned)minPin2Length usePinPad:(int)usePinPad
{
	...
	if(usePinPad) {
		...
		[pinFieldLabel setTitleWithMnemonic:[NSString stringWithUTF8String: l10nReplacePIN2("For signing enter PIN2 from PIN pad", pinName)]];
		...
		[pinFieldLabel setTitleWithMnemonic:[NSString stringWithUTF8String: l10nReplacePIN2("For signing enter PIN2:", pinName)]];
